  ...
  const fetchVechicle = async () => {
    ...
    try {
      ...
      setFormData({
        ...
        image: imageLinks,
        minKm: response.data?.vechicle?.minKm || "",
        bata: response.data?.vechicle?.bata || "",
        kmPrice: response.data?.vechicle?.kmPrice || "",
      });
    ...
    <div>
      ...
      <div className="container p-5 mt-3">
        ...
        <form onSubmit={handleSubmit} className="mt-5">
          ...
          {/* minKm Field */}
          <div className="mb-3">
            <label htmlFor="minKm" className="form-label">
              Minimum Kilometers
            </label>
            <input
              type="number"
          ...
          {/* bata Field */}
          <div className="mb-3">
            <label htmlFor="bata" className="form-label">
          ...
          {/* kmPrice Field */}
          <div className="mb-3">
            <label htmlFor="kmPrice" className="form-label">
              Price Per Kilometer
            </label>
            <input
              type="number"
